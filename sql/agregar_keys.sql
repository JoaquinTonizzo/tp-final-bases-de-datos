...
alter table correlatividad add constraint correlatividad_id_materia_fk foreign key (id_materia) references materia(id_materia);
alter table correlatividad add constraint correlatividad_id_mat_correlativa_fk foreign key (id_mat_correlativa) references materia(id_materia);
...
alter table cursada add constraint cursada_comision_fk foreign key (id_materia, id_comision) references comision(id_materia, id_comision);
...
alter table historia_academica add constraint historia_academica_comision_fk foreign key (id_materia, id_comision) references comision(id_materia, id_comision);
...
alter table entrada_trx add constraint entrada_trx_pk primary key (id_orden);
